...
pa_bluetooth_discovery* pa_bluetooth_discovery_get(pa_core *c) {
    ...
    pa_assert_se(dbus_connection_register_object_path(conn, HFP_AG_CVSD_ENDPOINT, &vtable_endpoint, y));
    pa_assert_se(dbus_connection_register_object_path(conn, HFP_HS_CVSD_ENDPOINT, &vtable_endpoint, y));
    pa_assert_se(dbus_connection_register_object_path(conn, HFP_AG_MSBC_ENDPOINT, &vtable_endpoint, y));
    pa_assert_se(dbus_connection_register_object_path(conn, HFP_HS_MSBC_ENDPOINT, &vtable_endpoint, y));
